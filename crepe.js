window.crepe = (function () {
  ...
  function process_microphone_buffer(event) {
    resample(event.inputBuffer, function (resampled) {
      tf.tidy(() => {
        ...
        // console.log('[process_microphone_buffer] I am here', confidence);
  ...
  async function initTF() {
    try {
      ...
      // window.model = await tf.loadModel('public/model/model.json');
